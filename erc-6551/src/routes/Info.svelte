	...
	{#if token}
		...
		>
			...
			>
				...
				>
					{tokenBoundAccountIsActive ? 'Token Bound NFT' : 'Non Token Bound NFT'}
				</div>
			</div>
			...
			>
				<div class="key-token-details-wrapper" style="position: relative; top: 40px;">
					...
					<div class="secondary-token-details-wrapper">
						...
						{#if !tokenBoundAccountIsActive}
							<div style="border-radius: 8px;font-size: 12px;">
								Upgrade this NFT to be Token Bound. Visit <a
									href="https://tokenbound.org/"
									target="_blank"
									style="color: rgb(110, 71, 243);">TokenBound.org</a
								>
							</div>
						{/if}
						{#if tokenBoundAccountIsActive}
							...
							>
								...
								>
									...
									>
										<g
											transform="matrix(3.42498,0,0,3.42498,-121.249,-121.247)"
										>
											<path
