...
export class MessageClient {
	private static BASE_URL = import.meta.env.VITE_MESSAGING_API_BASE_URL ?? "https://store-backend-stage.smartlayer.network/messaging";
	...
	public async postInviteFriend(friendId: number, signature:string){
		return (await this.requestWithAuth(`/invite-friend/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}`, "post", {friendId, signature}));
	}

	public async getSecureMessaging(friendId: number){
		return (await this.requestWithAuth(`/shared-key/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}/${friendId}`, "get"));
	}

	public async postSecureMessaging(sharedKey:string){
		return (await this.requestWithAuth(`/shared-key/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}`, "post", {sharedKey}));
	}

	public async getFriendInvites(){
		return (await this.requestWithAuth(`/friend-invites/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}`, "get"));
	}

	public async getApprovedFriend(){
		return (await this.requestWithAuth(`/friends-list/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}`, "get"));
	}

	public async getNewMessages(){
		return (await this.requestWithAuth(`/message-count/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}`, "get"));
	}

	public async getMessageHistory(friendId: number){
		return await this.requestWithAuth(`/message-history/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}/${friendId}`, "get");
	}

	public async sendMessage(message: string, friendId: number, encrypted: boolean){
		return await this.requestWithAuth(`/send-message/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}/${friendId}`, "post", {message, encrypted});
	}

	public async sendBroadcastMessage(message: string){
		return await this.requestWithAuth(`/send-broadcast-message/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}`, "post", {message});
	}

	public async getBroadcastMessages(){
		return await this.requestWithAuth(`/get-broadcast-messages/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.tokenId}`, "get");
	}
