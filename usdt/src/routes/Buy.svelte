<script lang="ts">
	...
	const swaps = [
		...
		},
		{
			...
			type: 'cex',
			logo: 'CryptoCOM',
			url: 'https://crypto.com/price/tether'
		},
		{
			title: 'DragonSwap',
			type: 'dex',
		...
		},
		{
			...
			type: 'cex',
			logo: 'OKX',
			url: 'https://www.okx.com/web3/dex-swap#inputChain=1&inputCurrency=0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE&outputChain=1&outputCurrency=0xdac17f958d2ee523a2206206994597c13d831ec7'
		},
		{
			title: 'kucoin',
			type: 'cex',
		...
		<div class="field-section" style="padding-bottom: 12px;">
			<div class="flex field-section" style="padding-left: 0">
				...
				<img
					...
					alt="logo"
					src="https://cdn.jsdelivr.net/gh/SmartTokenLabs/resources/images/logos/tether-logo.svg"
				/>
			</div>
			<div
				class="flex mt-6"
