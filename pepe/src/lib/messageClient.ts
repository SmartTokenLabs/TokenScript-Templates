...
export class MessageClient {
	...
	public async postInviteFriend(friendAddress: string) {
		return await this.requestWithAuth(
			`/invite-friend/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${friendAddress}`,
			'post',
			{ friendId: friendAddress }
		);
	}
	...
	public async postSecureMessaging(sharedKey: string) {
		return await this.requestWithAuth(
			`/shared-key/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${this.tokenContext.ownerAddress}`,
			'post',
			{ sharedKey }
		);
	}
	...
	public async getFriendInvites() {
		return await this.requestWithAuth(
			`/friend-invites/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}`,
			'get'
		);
	}
	...
	public async getOwnFriendInvites() {
		return await this.requestWithAuth(
			`/own-invites/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}`,
			'get'
		);
	}
	...
	public async getApprovedFriend() {
		return await this.requestWithAuth(
			`/friends-list/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}`,
			'get'
		);
	}
	...
	public async getNewMessages() {
		return await this.requestWithAuth(
			`/message-count/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}`,
			'get'
		);
	}

	public async getMessageHistory(friendAddress: string) {
		return await this.requestWithAuth(
			`/message-history/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}/${friendAddress}`,
			'get'
		);
	}
	...
	public async getBroadcastMessages() {
		return await this.requestWithAuth(
			`/get-broadcast-messages/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}`,
			'get'
		);
	}
	...
	public async getBroadcastMessageCount() {
		return await this.requestWithAuth(
			`/get-broadcast-unread-message-count/${this.tokenContext.chainId}/${this.tokenContext.contractAddress}`,
			'get'
		);
	}
